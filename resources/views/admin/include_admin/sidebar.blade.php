    ...
    <div class="left_col scroll-view">
      ...
      <div class="profile clearfix">
        <div class="profile_pic">
          <img src="{{asset('admin_master/production/images/img.jpg')}}" alt="..." class="img-circle profile_img">
        </div>
          ...
          <ul class="nav side-menu">
            <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                <li><a href="{{route('admin.order')}}">All Order Online</a></li>
                <li><a href="{{route('admin.order.create')}}">Create Order</a></li>
                <li><a href="{{route('admin.order.offline.history')}}">History Order Offline</a></li>
                <li><a href="{{route('admin.statistical')}}">Statistical</a></li>
              </ul>
            </li>
            <li><a><i class="fa fa-edit"></i> Products <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                ...
                <li><a href="{{route('admin.add_products')}}">Add Products</a></li>
              </ul>
            </li>
